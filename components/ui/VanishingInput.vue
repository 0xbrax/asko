<template>
    <form
        class="relative mx-auto h-12 w-full max-w-xl overflow-hidden bg-base-100 rounded-full shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),_0px_1px_0px_0px_rgba(25,28,33,0.02),_0px_0px_0px_1px_rgba(25,28,33,0.08)] transition duration-200"
    ...
    >
        ...
        <canvas
            ref="canvasRef"
            :class="[
        'pointer-events-none absolute left-2 top-[20%] origin-top-left scale-50 pr-20 text-base sm:left-8',
        ...
        <input
            ...
            :disabled="animating"
            type="text"
            class="relative z-50 size-full rounded-full border-none bg-transparent pl-4 pr-20 text-sm focus:outline-none focus:ring-0 sm:pl-10 sm:text-base"
        ...
        <button
            ...
            type="submit"
            class="absolute right-2 top-1/2 z-50 flex size-8 -translate-y-1/2 items-center justify-center rounded-full bg-secondary transition duration-200 disabled:btn-disabled"
        >
            <svg
                ...
                class="size-4 text-secondary-content"
            >
                <path
                    stroke="none"
                    d="M0 0h24v24H0z"
        ...
        <div class="pointer-events-none absolute inset-0 flex items-center rounded-full">
            ...
            >
                <p
                    ...
                    class="w-[calc(100%-2rem)] text-primary truncate pl-4 text-left text-sm font-normal sm:pl-10 sm:text-base"
                >
